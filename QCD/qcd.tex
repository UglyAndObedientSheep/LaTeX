...
\begin{equation}
\begin{matrix}
&\psi_L\to\psi_L'=e^{i\alpha_L}V_L\psi_L\;, &  \alpha_L\equiv \varphi_L/N_f\;, & V_L\in SU(N_f)\;, \\
\\
&\psi_R\to\psi_R'=e^{i\alpha_R}V_R\psi_R\;, & \alpha_R\equiv \varphi_R/N_f\;, & V_R\in SU(N_f)\;,
\end{matrix}
\end{equation}
